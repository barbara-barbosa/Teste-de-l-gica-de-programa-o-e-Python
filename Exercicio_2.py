...
print("2. Escreva um script em Python que acesse informação da CVM e pegue as informações referentes ao mês de fevereiro de 2019, e faça um gráfico de rendimento (mensal) do fundo SUL AMÉRICA APOLLO FUNDO DE INVESTIMENTO MULTIMERCADO (CNPJ: 17.797.493/0001-35) Dados disponíveis em: http://dados.cvm.gov.br/dados/FI/DOC/INF_DIARIO/DADOS/")
